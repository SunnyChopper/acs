	...
	<div class="container mt-64 mb-64">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<a href="/members/reviews/new" class="btn btn-sm btn-primary mt-2">Write New Review</a>
				@endif
				<hr />
			</div>
		</div>
				...
				<div class="jumbotron">
					...
					<div class="row">
						<div class="col-lg-4 offset-lg-4 col-md-4 offset-md-4 col-sm-6 offset-sm-3 col-xs-12">
							<a href="/members/reviews/new" class="btn btn-primary center-button mt-4 mb-0">Write New Review</a>
						</div>
					</div>
				</div>
			</div>
