				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{ $avg_reviews[$result->id] }}/5 ({{ $num_reviews[$result->id] }} reviews)</td>
							<td><button type="button" id="{{ $result->id }}" onclick="showCreateReviewModal(this.id);" class="btn btn-sm btn-warning">Leave Review</button></td>
							<td>
