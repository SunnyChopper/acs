	...
	<div class="container mt-64 mb-64">
		<div class="row">
			<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-12 col-xs-12">
				<form id="edit_listing" action="<?php echo e(url('/edit/listing/')); ?>" method="POST">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="first_name" value="<?php echo e($listing->first_name); ?>" placeholder="Elon" required>
						  	</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						  	<div class="form-group">
								...
								<input type="text" class="form-control" name="last_name" value="<?php echo e($listing->last_name); ?>" placeholder="Musk" required>
						  	</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<input type="email" class="form-control" name="email" value="<?php echo e($listing->email); ?>" placeholder="elon@tesla.com" required>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<input type="tel" class="form-control" name="phone" value="<?php echo e($listing->phone); ?>" placeholder="1-800-TESLA" required>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class='form-group'>
								...
								<input type='date' class='form-control' name='date_of_shipping' value="<?php echo e($listing->date_of_shipping); ?>" required>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="origin_city" value="<?php echo e($listing->origin_city); ?>" placeholder="Fremont" required>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="destination_city" value="<?php echo e($listing->destination_city); ?>" placeholder="Dallas" required>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<input type="number" class="form-control" step="1" min="1900" name="vehicle_year" placeholder="2018" value="<?php echo e($listing->vehicle_year); ?>" required>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<input type="text" placeholder="Tesla" name="vehicle_make" value="<?php echo e($listing->vehicle_make); ?>" class="form-control" required>
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<input type="text" placeholder="Model S" name="vehicle_model" value="<?php echo e($listing->vehicle_model); ?>" class="form-control" required>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								<label>Note:</label>
								<textarea placeholder="Please don't scratch the paint :)" class="form-control" rows="3" form="edit_listing" value="<?php echo e($listing->note); ?>"></textarea>
							</div>
						</div>
					</div>
