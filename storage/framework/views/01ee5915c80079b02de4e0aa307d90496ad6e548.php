...
<style type="text/css">
    .about-banner {
        background: url(<?php echo e(URL::asset('img/Front-Image.jpg')); ?>) center;
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>" aria-label="<?php echo e(__('Register')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="first_name" type="text" class="form-control<?php echo e($errors->has('first_name') ? ' is-invalid' : ''); ?>" name="first_name" value="<?php echo e(old('name')); ?>" required autofocus>
