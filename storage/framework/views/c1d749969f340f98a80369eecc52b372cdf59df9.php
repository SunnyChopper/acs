<?php $__env->startSection('content'); ?>
	<?php echo $__env->make('modals.create_review', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	...
	<div class="container mt-64 mb-64">
		<div class="row">
			<div class="col-lg-2 col-md-3 col-sm-12 col-xs-12">
				...
				<form action="<?php echo e(url('/members/search/')); ?>" method="post">
			...
			<div class="col-lg-10 col-md-9 col-sm-12 col-xs-12">
				...
				<table class="table table-striped">
					...
					<tbody>
						<?php $__currentLoopData = $search_results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							<td><?php echo e($result->name); ?></td>
							<td><?php echo e($result->city); ?>, <?php echo e($result->state); ?></td>
							<td><a class="btn btn-sm btn-primary" href="<?php echo e($result->website); ?>">Visit Site</a></td>
							<td><?php echo e($avg_reviews[$result->id]); ?>/5 (<?php echo e($num_reviews[$result->id]); ?> reviews)</td>
							<td><button type="button" id="<?php echo e($result->id); ?>" onclick="showCreateReviewModal(this.id);" class="btn btn-sm btn-warning">Leave Review</button></td>
							<td>
								<a class="btn btn-sm btn-success" href="tel:<?php echo e($result->phone); ?>">Call</a>
								<a class="btn btn-sm btn-success" href="mailto:<?php echo e($result->email); ?>">Email</a>
							</td>
						</tr>
