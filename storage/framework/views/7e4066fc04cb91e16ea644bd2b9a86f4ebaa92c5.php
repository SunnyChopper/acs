	...
	<div class="container mt-64 mb-64">
		<div class="row">
			<div class="col-lg-2 col-md-3 col-sm-12 col-xs-12">
				...
				<form action="<?php echo e(url('/guest/search/')); ?>" method="post">
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<?php echo e(url('/members/register/')); ?>">Signup</a> to view ratings</td>
							<td><a href="<?php echo e(url('/members/register/')); ?>">Signup</a> to leave reviews</td>
							<td>
