<?php $__env->startSection('content'); ?>
	...
	<div class="container mt-64 mb-64">
		<div class="row">
			<div class="col-lg-10 offset-lg-1 col-md-8 offset-md-2 col-sm-12 col-xs-12" style="background-color: #EEE; padding: 24px; border-radius: 8px;">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						...
						<p style="color: green; font-size: 24px; margin-top: 0px;">$<?php echo e($price); ?></p>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<div style="background-color: white; padding: 16px; border-radius: 8px;">
								...
								<div class="row">
									<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-12 col-xs-12">
										<input type="submit" id="submit_button" class="primary-btn" style="width: 100%;" value="Checkout">
									</div>
								</div>
							</div>
						</form>
